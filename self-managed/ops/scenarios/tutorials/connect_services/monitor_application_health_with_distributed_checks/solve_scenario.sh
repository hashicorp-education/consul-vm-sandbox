...
_RUN_CMD 'scp -r -i '${SSH_CERT}' /home/'${username}'/assets/scenario/conf/hashicups-api-1/svc-hashicups-api.hcl '${username}'@hashicups-api-1:/etc/consul.d/svc-hashicups-api.hcl'
